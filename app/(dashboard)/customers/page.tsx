...
import { Pencil, Search, Phone, AlertCircle, Trash2 } from 'lucide-react'
...
export default function CustomersPage() {
  ...
  return (
    <div className="p-8">
            ...
            {loading ? (
              ...
              <tr>
                <td colSpan={8} className="table-td text-center py-12 text-slate-600">
                  {search || filterStatus || selectedBranch || selectedBatch
              ...
              filtered.map((c) => {
                ...
                return (
                  <tr key={c.id} className="table-row">
                      ...
                      <div>
                        ...
                        <a
                          href={buildWhatsAppLink(
                            c.phone,
                            buildPaymentWhatsAppMessage(c.name, pending)
                          )}
                          target="_blank"
                          rel="noopener noreferrer"
                          className="flex items-center gap-1 text-xs text-emerald-500 hover:text-emerald-400 mt-0.5"
                        >
                          <Phone size={10} />
                          {c.phone}
                        </a>
                    ...
                    <td className="table-td font-medium">{formatINR(c.total_amount)}</td>
                    ...
                    <td className="table-td">
                      <div className="flex items-center justify-end gap-2">
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="px-2 py-1 rounded-md bg-emerald-500/10 text-emerald-400 hover:bg-emerald-500/20 text-xs font-medium"
                        >
                          Reminder
                        </a>
      ...
      {showModal && (
        <Modal title="Edit Customer" onClose={() => setShowModal(false)} size="lg">
          <div className="grid grid-cols-2 gap-4">
            ...
            <Input
              ...
              onChange={(e) => setForm({ ...form, service_taken: e.target.value })}
            />
